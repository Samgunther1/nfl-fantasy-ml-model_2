...
cfb <- read_csv("data/processed/cfb_to_nfl_wr_modeling.csv")
nfl <- read_csv("data/processed/nfl_to_nfl_wr_train.csv")
...
combined <- combined %>% filter(games >= 4 & target_games >= 4)
